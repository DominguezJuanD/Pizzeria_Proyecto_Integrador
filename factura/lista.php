...
if(isset($_POST['consulta'])){
	...
	$query = "SELECT tipComprob,serieComprob ,numComprob, fechaComprob, fromaPago, subtotal, iva, total  WHERE fechaComprob like '%".$id."%' or numComprob like '%".$id."%' or tipComprob like '%".$id."%' ";
}
...
//tc INNER JOIN FormaPago fp WHERE tc.tipoCompraVanta = IN(1) AND fp.idFormaPago = tc.formaPago;
echo $salida;
